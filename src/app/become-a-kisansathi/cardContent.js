...
const LeftContent = () => {
  return (
    <div className="lg:mt-12 lg:mr-10 small:mt-60 items-center content-center text-sm">
      <Heading classname="items=center" value="Who is a Kisansathi?" />
...
const RightImage = () => {
  return (
    <div className="lg:ml-16 lg:mt-8  p-4 ">
      <img
