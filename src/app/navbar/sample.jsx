...
const Navigation = () => {
  ...
  return (
    <div className="justify-center items-center">
      <nav className="fixed left-1/2 transform -translate-x-1/2  py-1 items-center bg-gray-700 rounded-3xl">
      ...
      <div className="flex flex-row mt-24">
        <div className="flex flex-row">
          <div className="flex flex-col mt-48 pt-2">

            <img width={600} height={200} src="./Farm1.png"></img>
            <br></br>
            <img width={650} height={700} src="./Farm2.png"></img>
          </div>
        </div>

        <div className=" navigation-container flex flex-col ">
