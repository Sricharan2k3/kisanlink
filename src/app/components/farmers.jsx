...
const SkeletonOne = () => {
  ...
  return (
    ...
    >
      ...
      <Image src="https://www.kisanlink.in/wp-content/uploads/farmers-1.jpg" height={165} width={255}/>
    </motion.div>
  );
};
const SkeletonTwo = () => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-1 w-full h-full min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-col space-y-2"
    >
      <Image src="https://www.kisanlink.in/wp-content/uploads/farmers-2.jpg" height={165} width={265}/>
    </motion.div>
  );
};
const SkeletonThree = () => {
  ...
  return (
    ...
    >
      <motion.div className="h-full w-full rounded-lg">
        ...
        <Image src="https://www.kisanlink.in/wp-content/uploads/farmers-4.jpg" height={165} width={255}/>
      </motion.div>
    </motion.div>
  );
};
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      ...
      >
      <Image
          src="https://www.kisanlink.in/wp-content/uploads/trust.jpg"
          alt="avatar"
          height="100"
          width="100"
      ...
      <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
        <Image
          src="https://www.kisanlink.in/wp-content/uploads/training.jpg"
          alt="avatar"
          height="100"
          width="100"
          className=" h-full w-full"
...
const SkeletonFive = () => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-1 w-full h-full min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-col space-y-2"
    >
      <Image src="https://www.kisanlink.in/wp-content/uploads/farmers-3.jpg" height={165} width={255}/>
    </motion.div>
  );
};
const items = [
