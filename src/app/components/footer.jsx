...
<div className='mt-8'>
    ...
    <div className='mt-6'>
    <p class="mb-4 flex items-center  lg:justify-start"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="mr-3 h-5 w-5"><path d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z"></path><path d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z"></path></svg>Plot no 27, Nandi Hills, Road no 51, Jubliee Hills, Hyderabad, 500033</p>
...
{/* <div className='mt-16'>
<a className='hover:text-green-700' href="./tandc "><p class="mb-4 flex items-center  lg:justify-start">Terms And Conditions</p></a>
<a className='hover:text-green-700' href="./privacy-policy"><p class="mb-4 flex lg:items-center lg:justify-start">Privacy Policy</p>  </a>
</div> */}
                    ...
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        ...
                        <ul className="mt-6 space-y-4">
                            ...
                            <li>
                                <a href="/ecommerce/#services" title="" className="flex text-base text-black transition-all duration-200 hover:text-green-600 focus:text-green-600"> Drone Inputs Application </a>
                            </li>

                            <li>
                                <a href="/ecommerce/#services" title="" className="flex text-base text-black transition-all duration-200 hover:text-green-600 focus:text-green-600">Advisory Services </a>
                            </li>

                            <li>
                                <a href="/ecommerce/#services" title="" className="flex text-base text-black transition-all duration-200 hover:text-green-600 focus:text-green-600">Output Purchase</a>
                            </li>
                            <li>
                                <a href="/ecommerce/#services" title="" className="flex text-base text-black transition-all duration-200 hover:text-green-600 focus:text-green-600">Facilitation of Government Subsidy/Schemes</a>
                            </li>
...
<a className='hover:text-green-700' href="./privacy-policy"><p class="mb-4 flex lg:items-center lg:justify-start">Privacy Policy</p>  </a>
                    ...
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        ...
                        <ul className="mt-6 space-y-4">
                            <li>
                                <a href="./blog4" title="" className="flex text-base text-black transition-all duration-200 hover:text-green-600 focus:text-green-600"> Government policies and support for FPOs in India </a>
                            </li>

                            <li>
                                <a href="./blog6" title="" className="flex text-base text-black transition-all duration-200 hover:text-green-600 focus:text-green-600"> Empowering Smallholder Farmers: The Transformative Role of Farmer Producer Organizations (FPOs) </a>
                            </li>

                            <li>
                                <a href="/blog7" title="" className="flex text-base text-black transition-all duration-200 hover:text-green-600 focus:text-green-600"> Cultivating Sustainability: The Integral Role of Farmer Producer Organizations (FPOs) in Agriculture </a>
                            </li>

                            <li>
                                <a href="/blog5" title="" className="flex text-base text-black transition-all duration-200 hover:text-green-600 focus:text-green-600">Harnessing Collective Strength: Exploring the Benefits of Farmer Producer Organizations (FPOs) </a>
                            </li>

                            <li>
                                <a href="/blog1" title="" className="flex text-base text-black transition-all duration-200 hover:text-green-600 focus:text-green-600">The Role of Farmer Producer Organizations (FPOs) and Regulatory Framework </a>
                            </li>
                        </ul>
                    </div>
