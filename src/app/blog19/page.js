            ...
            <article className="prose prose-gray max-w-none p-8">
              ...
              <div className="flex flex-col md:flex-row items-start gap-8 mt-8">
                ...
                <div>
                  ...
                  />
                  <ul className="list-disc space-y-4 list-inside mt-4">
                    <li>
                      Financial Contributions: The fund comprises ₹250 crore
                      from the Government of India, ₹250 crore from the National
                      Bank for Agriculture and Rural Development (NABARD), and
                      ₹250 crore mobilized from banks, insurance companies, and
                      private investors.
                    </li>
                    <li>
                      Focus Areas: It targets high-risk, high-impact activities
                      across the agricultural value chain, including enhancing
                      farm produce value chains, creating rural infrastructure,
                      and supporting Farmer Producer Organizations (FPOs).
                    </li>
                    <li>
                      Support for Innovation: The fund will encourage the
                      development of IT-based solutions, machinery rental
                      services, and other innovative approaches to address
                      farmers' challenges, thereby fostering a sustainable
