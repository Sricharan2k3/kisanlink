        ...
        {sections.map((section, index) => (
          ...
          >
            <div className="container px-4 md:px-6">
              <div className={`grid items-center gap-6 ${index % 2 === 0 ? 'lg:grid-cols-[1fr_500px] xl:grid-cols-[1fr_550px]' : 'lg:grid-cols-[500px_1fr] xl:grid-cols-[550px_1fr]'} lg:gap-12`}>
                {index % 2 !== 0 && (
                  <img
                    src={section.imgSrc}
                    width="550"
                ...
                <div className="space-y-4">
                  <div className="inline-block rounded-lg bg-muted px-3 py-1 text-sm">{section.subtitle}</div>
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">{section.heading}</h2>
