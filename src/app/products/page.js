          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-primary-foreground md:text-xl">
                Explore our carefully selected products that combine style, quality, and functionality.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8 mb-8">
            <div className="grid gap-1">
              ...
              <p className="text-muted-foreground">Browse our curated selection of products.</p>
            </div>
            ...
            {filteredProducts.map((product) => (
              <div key={product.id} className="relative overflow-hidden rounded-lg group">
                ...
                <div className="p-4 bg-background">
                  ...
                  <h4 className="text-base font-semibold md:text-lg">${product.price.toFixed(2)}</h4>
                </div>
              </div>
            ))}
          </div>
