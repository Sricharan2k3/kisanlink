...
const Career = () => {
  return (
    <>
      ...
      <div className="max-width-full h-80 bg-green-600 pr-16 flex items-center justify-center">
        <div className="overlay-bg max-width-full ">
          <div className="text-center mt-96 flex  max-width-full content-end">
            <img src="https://www.kisanlink.in/wp-content/uploads/Hiring-cuate.svg" className="w-80 h-80 " />
            <h1 className="text-lg lg:text-4xl ml-32 w-96 mt-32 font-bold text-white text-center mr-80 w-96 ">
              Open Positions
            </h1>
      ...
      <img src="https://www.kisanlink.in/wp-content/uploads/2022/07/agriculture-ge5750e9ae_1280-removebg-e1657976152581.png" className="w-full h-48" alt="" />
